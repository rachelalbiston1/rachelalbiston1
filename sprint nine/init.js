...
var colArray=[
    [ "rgba(102, 102, 102,1)", "rgba(153,153,1)", "rgba(220,150,90,1)", 
      "rgba(254,53,53,1)","rgba(254,137,53,1)","rgba(255,254,130,1)",
      "rgba(112,255,82,1)","rgba(58,237,255,1)", "rgba(196,58,255,1)"
    ],
    [ "rgba(179, 179, 179,0.67)", "rgba(153,153,153,0.67)", "rgba(0,0,0,0.67)", 
     ...
     [ "rgba(255,255,255,0.60)", "rgba(153,153,153,0.33)", "rgba(0,0,0,0.33)", 
